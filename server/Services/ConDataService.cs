...
namespace InsertStoredProcDemo
{
    public partial class ConDataService
    {
        ...
        public async Task ExportMarketsToExcel(Query query = null)
        {
            navigationManager.NavigateTo(query != null ? query.ToUrl("export/condata/markets/excel") : "export/condata/markets/excel", true);
        }

        public async Task ExportMarketsToCSV(Query query = null)
        {
            navigationManager.NavigateTo(query != null ? query.ToUrl("export/condata/markets/csv") : "export/condata/markets/csv", true);
        }
